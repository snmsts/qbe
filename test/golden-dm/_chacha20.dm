...
@start
	...
	%in.33 =l add %in.32, 4
	%counter.115 =w copy 10
@loop
	%counter.116 =w phi @start %counter.115, @loop %counter.229
...
@done
	...
	%out.9 =l add %out.8, 4
	storew %t9.226, %out.9
	%out.10 =l add %out.9, 4
	storew %t10.190, %out.10
	%out.11 =l add %out.10, 4
	storew %t11.202, %out.11
	%out.12 =l add %out.11, 4
	storew %t12.201, %out.12
	%out.13 =l add %out.12, 4
	storew %t13.213, %out.13
	%out.14 =l add %out.13, 4
	storew %t14.225, %out.14
	%out.15 =l add %out.14, 4
	storew %t15.189, %out.15
	%out.16 =l add %out.15, 4
	ret0
}
