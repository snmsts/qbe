...
(defpackage #:qbe
  ...
  (:export
   ...
   ;; load elimination + alias analysis (C1) + slot coalescing (C2)
   ...
   #:*amd64-sysv-target* #:*amd64-apple-target* #:*amd64-win-target*
   ...
   #:arm64-isel #:*arm64-apple-target* #:*arm64-elf-target* #:*arm64-win-target*
   #:arm64-logimm
